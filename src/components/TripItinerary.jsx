...
export default function TripItinerary({ events, onEventClick}) {
  ...
  const [currentDate, setCurrentDate] = useState(formatDate(new Date('2025-06-23')))
    ...
    <FullCalendar
      ...
      dayHeaderContent={() => (
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <button onClick={() => { calendarRef.current.getApi().gotoDate('2025-06-23'); setCurrentDate(formatDate(new Date('2025-06-23'))) }}>{currentDate}</button>
